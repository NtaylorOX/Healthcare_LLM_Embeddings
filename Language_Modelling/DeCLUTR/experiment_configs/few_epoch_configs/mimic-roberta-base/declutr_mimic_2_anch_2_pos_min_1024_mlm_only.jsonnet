...
local transformer_model = "/mnt/sdg/niallt/saved_models/language_modelling/mimic/roberta-base-mimic/sampled_250000/22-12-2022--12-45/checkpoint-100000/";
...

{
    ...
    "train_data_path": "/mnt/sdg/niallt/mimic_iii/processed/HADM_ID_split/declutr/sample_250000/min_1024/train.txt",    
    "model": {
        "type": "declutr",
        "text_field_embedder": {
            "type": "mlm",
