    ...
    def __init__(
        ...
        *,
        ...
        if self.masked_language_modeling:
            ...
            # need to ensure output_hidden_states = True to get embeddings etc - see: https://github.com/JohnGiorgi/DeCLUTR/commit/802aa564f978a730bcc74ec082370e1026e75fc9
    ...
    def forward(
        ...
        if self.config.output_hidden_states:
            ...
            if "labels" in parameters:
                ...
                # print(f"\ninput ids in params: {parameters['input_ids'][0]}")
                # print(f"\nlabels in params: {parameters['labels'][0]}")
