...
class DataCollatorForPreTraining(DataCollatorMixin):
    ...
    def torch_call(self, examples: List[Union[List[int], Any, Dict[str, Any]]]) -> Dict[str, Any]:
        ...
        # If special token mask has been preprocessed, pop it from the dict.
        special_tokens_mask = batch.pop("special_tokens_mask", None)
        #TODO add functionality to return a tensor of the original input ids alongside the masked ones in the case of doing mlm to allow embeddings to be produced for the original inputs for contrastive loss
        if self.mlm:
