...

{
    ...
    "train_data_path": "/mnt/sdg/niallt/mimic_iii/processed/HADM_ID_split/declutr/sample_50/min_2048/train.txt",    
    "model": {
        "type": "declutr",
        "text_field_embedder": {
            "type": "mlm",
    ...
    "data_loader": {
        "batch_size": 1,
        "num_workers": 1, // on windows multi-processing is not working for allennlp 
        "drop_last": true,
    },
    "trainer": {
