...
class DeCLUTR(Model):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # print(f"self masked_language_modelling is: {self._masked_language_modeling}")
    ...
    def forward(  # type: ignore
        ...
        # recent pytorch updates mean if a loss is produced/returned and note used in the backprop - it will throw errors pertaining to having unused params or something. 
        if not self._masked_language_modeling:    
            # print(f"returned mlm loss was: {masked_lm_loss}")        
            masked_lm_loss = None            
            # print(f"returned MLM loss will be converted to None")
