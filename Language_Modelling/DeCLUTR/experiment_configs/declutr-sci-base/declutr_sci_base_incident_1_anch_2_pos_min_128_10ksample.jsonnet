...
local transformer_model = "johngiorgi/declutr-sci-base";
...

{
    ...
    "train_data_path": "E:/working_incident_data/cleaned_data/declutr_lm/bert-sci-base/sample_10000/min_128/train.txt",    
    "model": {
        "type": "declutr",
        "text_field_embedder": {
            "type": "mlm",
